# استشارات FAC للموارد البشرية - موقع ملف الشركة

موقع ويب احترافي ومتجاوب لشركة استشارات FAC للموارد البشرية تم بناؤه باستخدام HTML5 و CSS3 و Bootstrap 5 و JavaScript.
...
2. **معلومات الشركة**: نظرة عامة على استشارات FAC للموارد البشرية، المهمة، والقيم
...
تم إنشاء هذا المشروع لشركة استشارات FAC للموارد البشرية.
...
**تم البناء بـ ❤️ لاستشارات FAC للموارد البشرية**
